#!/usr/bin/env python3
"""Audit equivalence between original 10GB SoFiA configs and Phase 3 40GB configs."""
...
def main() -> None:
    ...
    parser.add_argument("--out-dir", type=Path, default=PHASE3_ROOT / "outputs" / "config_audit")
