#!/usr/bin/env python3
"""Extract frozen Phase 2 features for external merged 40GB tiled catalogues."""
...
from phase03_utils import LARGE_CUBE, ensure_dir
...
EXTRACTOR = PHASE3_ROOT.parent / "phase_02_spectral_features" / "01_extract_spectral_features" / "scripts" / "01_extract_candidate_z_features.py"
...
def write_extractor_config(candidate_paths: dict[str, Path]) -> Path:
    ...
    config_path = OUT_DIR / "phase3_external_tiles_phase2_features_config.yaml"
