...
Aplicar sobre una región ampliada del cubo de 40 GB las configuraciones SoFiA, modelos y thresholds obtenidos en las fases anteriores. Los artefactos se utilizan congelados: no se reentrenan modelos ni se recalibran thresholds con los datos de esta fase.

## Estructura

| Carpeta | Función |
|---|---|
| `01_region_definition` | Comprueba el solape WCS, audita configuraciones y genera el truth externo. |
...
| `phase03_utils.py` | Define rutas, regiones y utilidades compartidas. |
...
La región de 10 GB usada durante el desarrollo se excluye espacialmente. Esta fase constituye una validación ampliada dentro de los datos SDC2, no un conjunto externo completamente independiente.
