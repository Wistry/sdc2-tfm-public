...
from phase03_utils import CONFIGS, find_tile_catalog, inside_central_10gb_region, read_sofia_catalog


META = PHASE3_ROOT / "outputs" / "tile_metadata" / "tiles_40gb_external.csv"
AUDIT = PHASE3_ROOT / "outputs" / "tile_catalog_audit" / "tile_coordinate_audit.csv"
OUT_DIR = PHASE3_ROOT / "outputs" / "merged_tile_catalogs"
