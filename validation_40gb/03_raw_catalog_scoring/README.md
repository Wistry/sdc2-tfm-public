...
Normalizar las coordenadas de los catálogos por tile, fusionar la región de validación ampliada en 40 GB y calcular el score oficial de los catálogos raw.

## Entrada

- Catálogos SoFiA generados por tiles.
- Truth catalogue de la región ampliada.
- Scorer oficial SDC2.
