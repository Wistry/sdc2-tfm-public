...
Extraer patches locales, aplicar CNN congeladas y evaluar sus catálogos sobre la región de validación ampliada en 40 GB.

## Entrada

- Cubo FITS de 40 GB y catálogos fusionados de la región ampliada.
